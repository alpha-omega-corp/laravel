  ...
  <header class="bg-indigo-600 pb-24 dark:bg-indigo-800">
      ...
      <div class="relative flex items-center justify-center py-5 lg:justify-between">
        ...
        <div class="absolute left-0 shrink-0 lg:static">
          <a href="#">
            ...
            <img src="https://tailwindcss.com/plus-assets/img/logos/mark.svg?color=indigo&shade=300" alt="Your Company" class="h-8 w-auto" />
          </a>
        </div>
        ...
        <div class="hidden lg:ml-4 lg:flex lg:items-center lg:pr-0.5">
          ...
          <el-dropdown class="relative ml-4 shrink-0">
            <button class="relative flex max-w-xs items-center rounded-full bg-indigo-600 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-white">
              <span class="absolute -inset-1.5"></span>
            ...
            <el-menu anchor="bottom end" popover class="ml-2 w-48 origin-top-right rounded-md bg-white py-1 shadow-lg outline outline-black/5 [--anchor-gap:--spacing(2)] data-leave:transition data-leave:duration-75 data-leave:ease-in data-closed:data-leave:scale-95 data-closed:data-leave:transform data-closed:data-leave:opacity-0 dark:bg-gray-800 dark:-outline-offset-1 dark:outline-white/10">
        ...
        <div class="min-w-0 flex-1 px-12 lg:hidden">
          <div class="mx-auto grid w-full max-w-xs grid-cols-1">
            <input name="search" placeholder="Search" aria-label="Search" class="col-start-1 row-start-1 block w-full rounded-md bg-indigo-500/75 py-1.5 pr-3 pl-10 text-base text-white outline-1 -outline-offset-1 outline-white/10 placeholder:text-white/75 focus:outline-2 focus:-outline-offset-2 focus:outline-white sm:text-sm/6 dark:bg-indigo-700/50 dark:outline-indigo-400/25 dark:placeholder:text-white/50" />
            <svg viewBox="0 0 20 20" fill="currentColor" data-slot="icon" aria-hidden="true" class="pointer-events-none col-start-1 row-start-1 ml-3 size-5 self-center text-white/75 dark:text-white/50">
        ...
        <div class="absolute right-0 shrink-0 lg:hidden">
          <!-- Mobile menu button -->
          <button command="show-modal" commandfor="mobile-menu" class="relative inline-flex items-center justify-center rounded-md bg-transparent p-2 text-indigo-200 hover:bg-white/5 hover:text-white focus-visible:outline-2 focus-visible:outline-white">
        ...
        <div class="grid grid-cols-3 items-center gap-8">
          <div class="col-span-2">
            <nav class="flex space-x-4">
              ...
              <a href="#" aria-current="page" class="rounded-md px-3 py-2 text-sm font-medium text-white hover:bg-indigo-500/75 dark:hover:bg-indigo-700/75">Home</a>
              <a href="#" class="rounded-md px-3 py-2 text-sm font-medium text-indigo-100 hover:bg-indigo-500/75 dark:hover:bg-indigo-700/75">Profile</a>
              <a href="#" class="rounded-md px-3 py-2 text-sm font-medium text-indigo-100 hover:bg-indigo-500/75 dark:hover:bg-indigo-700/75">Resources</a>
              <a href="#" class="rounded-md px-3 py-2 text-sm font-medium text-indigo-100 hover:bg-indigo-500/75 dark:hover:bg-indigo-700/75">Company Directory</a>
              <a href="#" class="rounded-md px-3 py-2 text-sm font-medium text-indigo-100 hover:bg-indigo-500/75 dark:hover:bg-indigo-700/75">Openings</a>
            </nav>
          </div>
    ...
    <el-dialog>
      <dialog id="mobile-menu" class="backdrop:bg-transparent lg:hidden">
        <el-dialog-backdrop class="fixed inset-0 bg-black/25 duration-150 data-closed:opacity-0 data-enter:ease-out data-leave:ease-in"></el-dialog-backdrop>

        <div tabindex="0" class="fixed inset-0 focus:outline-none">
          <!-- Mobile menu, show/hide based on mobile menu state. -->
          <el-dialog-panel class="absolute inset-x-0 top-0 mx-auto w-full max-w-3xl origin-top transform p-2 transition duration-150 data-closed:scale-95 data-closed:opacity-0 data-enter:ease-out data-leave:ease-in">
              ...
              <div class="pt-4 pb-2">
                <div class="flex items-center px-5">
                  ...
                  <div class="ml-3 min-w-0 flex-1">
                    <div class="truncate text-base font-medium text-gray-800 dark:text-gray-200">Tom Cook</div>
                    <div class="truncate text-sm font-medium text-gray-500 dark:text-gray-400">tom@example.com</div>
                  </div>
                ...
                <div class="mt-3 space-y-1 px-2">
                  <a href="#" class="block rounded-md px-3 py-2 text-base font-medium text-gray-900 hover:bg-gray-100 hover:text-gray-800 dark:text-gray-100 dark:hover:bg-white/5 dark:hover:text-white">Your profile</a>
                  <a href="#" class="block rounded-md px-3 py-2 text-base font-medium text-gray-900 hover:bg-gray-100 hover:text-gray-800 dark:text-gray-100 dark:hover:bg-white/5 dark:hover:text-white">Settings</a>
                  <a href="#" class="block rounded-md px-3 py-2 text-base font-medium text-gray-900 hover:bg-gray-100 hover:text-gray-800 dark:text-gray-100 dark:hover:bg-white/5 dark:hover:text-white">Sign out</a>
                </div>
              </div>
            </div>
          </el-dialog-panel>
